...
public class UserControllerIntegrationTest {
    ...
    @Test
    @WithMockUser(roles = "ADMIN")
    void showUpdateForm_WithInvalidId_ShouldRedirectToErrorPage() throws Exception {

        // Given: No user is found for the provided ID (99)
        when(userRepository.findById(99)).thenReturn(Optional.empty());

        // When: Performing GET request to /user/update/99
        // Then: Expect a redirection to the error page with a flash error message
    ...
    @Test
    void accessUserList_WithoutAuthentication_ShouldRedirectToLogin() throws Exception {

        // Given: No user is authenticated
        // When: Performing GET request to /user/list with Accept header as text/html
        // Then: Expect a redirection (HTTP 3xx) to the login page
        mockMvc.perform(get("/user/list")
